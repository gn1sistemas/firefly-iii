...
return [
    ...
    'expenses_by_category'                       => 'Despesa por plano de contas',
    'expenses_by_budget'                         => 'Despesas pelo orçamento',
    'income_by_category'                         => 'Receitas por plano de contas',
    ...
    'chart_category_in_period'                   => 'Gráfico para todas as transações para o plano de contas ":name" entre :start e :end',
    'chart_cost_center_in_period'                => 'Gráfico para todas as transações para o centro de custo ":name" entre :start e :end',
    'chart_category_all'                         => 'Gráfico para todas as transações para o plano de contas ":name"',
    ...
    'all_journals_without_category'              => 'Todas as transações sem um plano de contas',
    'journals_without_category'                  => 'Transações sem um plano de contas',
    ...
    'all_journals_for_category'                  => 'Todas as transações paro plano de contas :name',
    ...
    'journals_in_period_for_category'            => 'Todas as transações para o plano de contas :name entre :start e :end',
    ...
    'search_modifier_category'                   => 'plano de contas é :value',
    ...
    'rule_trigger_category_is_choice'            => 'o plano de contas é..',
    'rule_trigger_category_is'                   => 'o plano de contas é ":trigger_value"',
    'rule_trigger_cost_center_is_choice'         => 'O centro de custo é..',
    'rule_trigger_cost_center_is'                => 'O centro de custo é ":trigger_value"',
    ...
    'rule_trigger_has_no_category_choice'        => 'Não tem plano de contas',
    'rule_trigger_has_no_category'               => 'A transação não tem plano de contas',
    'rule_trigger_has_any_category_choice'       => 'Tem um plano de contas (qualquer)',
    'rule_trigger_has_any_category'              => 'A transação tem um plano de contas (qualquer)',
    ...
    'rule_action_set_category'                   => 'Definir plano de contas para ":action_value"',
    'rule_action_clear_category'                 => 'Limpar plano de contas',
    'rule_action_clear_cost_center'              => 'Limpar centro de custo',
    'rule_action_set_cost_center'                => 'Definir centro de custo para ":action_value"',
    'rule_action_clear_cost_center'              => 'Limpar centro de custo',
    ...
    'rule_action_set_category_choice'            => 'Definir o plano de contas para..',
    'rule_action_clear_category_choice'          => 'Limpar qualquer plano de contas',
    'rule_action_set_cost_center_choice'         => 'Definir o centro de custo para..',
    'rule_action_clear_cost_center_choice'       => 'Limpar qualquer centro de custo',
    ...
    'select_at_least_one_category'            => 'Por favor selecione, pelo menos, um plano de contas',
    'select_at_least_one_cost_center'         => 'Por favor selecione, pelo menos, um centro de custo',
    ...
    // categories:
    'new_category'                            => 'Novo plano de contas',
    'create_new_category'                     => 'Criar uma novo plano de contas',
    'without_category'                        => 'Sem um plano de contas',
    'update_category'                         => 'Atualizar plano de contas',
    'updated_category'                        => 'Atualizado plano de contas ":name"',
    'categories'                              => 'Planos de contas',
    'edit_category'                           => 'Editar plano de contas ":name"',
    'no_category'                             => '(sem plano de contas)',
    'category'                                => 'plano de contas',
    'delete_category'                         => 'Excluir plano de contas ":name"',
    'deleted_category'                        => 'plano de contas ":name" excluída',
    'store_category'                          => 'Armazenar novo plano de contas',
    'stored_category'                         => 'Armazenada novo plano de contas ":name"',
    'without_category_between'                => 'Sem plano de contas entre :start e :end',
    ...
    'category_overview'                       => 'Visão geral do plano de contas',
    ...
    'report_category'                         => 'Relatório de plano de contas entre :start e :end',
    'report_cost_center'                      => 'Relatório de centro de custo entre :start e :end',
    ...
    'noCategory'                              => '(sem plano de contas)',
    ...
    'report_type_category'                    => 'Relatório por Planos de contas',
    'report_type_cost_center'                 => 'Relatório por Centros de Custo',
    ...
    'category_entry'                          => 'Despesas no plano de contas ":name" entre :start e :end',
    ...
    'select_category'                         => 'Selecionar plano de contas(s)',
    'select_cost_center'                      => 'Selecionar centro(s) de custo',
    'select_budget'                           => 'Selecionar orçamento(s).',
    'select_tag'                              => 'Selecionar tag(s).',
    'income_per_category'                     => 'Receitas por plano de contas',
    'expense_per_category'                    => 'Despesa por plano de contas',
    'income_per_cost_center'                  => 'Receitas por centro de custo',
    'expense_per_cost_center'                 => 'Despesa por centro de custo',
    ...
    'include_expense_not_in_category'         => 'Despesas não incluídas na(s) plano de contas(s) selecionada(s)',
    'include_income_not_in_category'          => 'Rendimento não incluído na(s) plano de contas(s) selecionada(s)',
    'include_income_not_in_cost_center'       => 'Rendimento não incluído na(s) centro(s) de custo selecionado(s)',
    'include_expense_not_in_cost_center'      => 'Despesas não incluídas na(s) centro(s) de custo selecionado(s)',
    ...
    'category_chart_click'                    => 'Clique no nome do plano de contas na tabela acima para ver um gráfico.',
    'in_out_accounts'                         => 'Ganhou e gastou por combinação',
    'in_out_per_category'                     => 'Ganhou e gastou por plano de contas',
    ...
    'no_categories_title_default'           => 'Vamos criar um plano de contas!',
    'no_categories_intro_default'           => 'Você ainda não possui Planos de contas. os planos de contas são usadas para ajustar suas transações e rotulá-las com o plano de contas designada.',
    'no_categories_imperative_default'      => 'os planos de contas são criadas automaticamente quando você cria transações, mas você também pode criar uma manualmente. Vamos criar uma agora:',
    'no_categories_create_default'          => 'Criar um plano de contas',
    'no_cost-centers_title_default'         => 'Vamos criar um centro de custo!',
    'no_cost-centers_intro_default'         => 'Você ainda não possui Centro de custos. Os centros de custo são usados para ajustar suas transações e rotulá-las com o centro designado. ',
    'no_cost-centers_imperative_default'    => 'Os centros de custo são criados automaticamente quando você cria transações, mas você também pode criar uma manualmente. Vamos criar uma agora: ',
    'no_cost-centers_create_default'        => 'Criar um centro de custo',
